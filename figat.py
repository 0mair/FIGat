...
try:
	...
	print(R + 'F I Gat'.center(44))
	print(W + ' ')
	print(('F I Gat').center(44))
	print(' ')
...
def baliho():
	try:
		...
		print(' ' + W)
		print(('F I Gat').center(44))
		print((W + '     [' + G +'Facebook Information Gatherer'+ W + ']'))
		print(' ')
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Omair (0mairr)
    Name       FIGat (Facebook Information Gatherer)
    CodeName   omr
    version    v1.0
    Date       30/04/2019 01:32:12
    Email      omr@techie.com
    Telegram   @omairr
...
def id():
	...
	x = hashlib.new('md5',encoding='utf-8')
	...
	try:
		if WT == 'wallpost':
			...
			for i in result['home']['data']:
				print('\r[*] %s retrieved   '%(i['id']), end=' ');sys.stdout.flush();time.sleep(0.1)
			...
			for i in result['data']:
				print('\r[*] %s retrieved    '%(i['from']['id']), end=' ');sys.stdout.flush();time.sleep(0.01)
			return result['data']
			...
			for i in result['friends']['data']:
				print('\r[*] %s retrieved    '%(i['id']), end=' ');sys.stdout.flush();time.sleep(0.001)
			...
			for i in result['data']:
				print('\r[*] %s retrieved    '%(i['id']), end=' ');sys.stdout.flush();time.sleep(0.01)
			return result
...
def menu_reaction_ask():
	try:
		...
		cek = input(R + 'omr' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def getdata():
	...
	for i in a['data']:
		jml.append(i['id'])
		print('\r[*] fetching %s data from friends'%(len(jml)), end=' ');sys.stdout.flush();time.sleep(0.0001)
